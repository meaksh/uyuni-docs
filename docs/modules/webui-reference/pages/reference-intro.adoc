...
include::_common-documents/common_intro_available_doc_i.adoc[leveloffset=1]

//ifdef::env-github,backend-html5[]
//<<common_intro_available_doc_i.adoc#intro_available_doc, Available Documentation>>
//endif::[]

include::_common-documents/common_intro_feedback_i.adoc[leveloffset=1]

//ifdef::env-github,backend-html5[]
//<<common_intro_feedback_i.adoc#intro_feedback, Feedback>>
//endif::[]

include::_common-documents/common_intro_typografie_i.adoc[leveloffset=1]

//ifdef::env-github,backend-html5[]
//<<common_intro_typografie_i.adoc#intro_typografie, Documentation Conventions>>
//endif::[]

include::_common-documents/common_intro_typografie_suma.adoc[leveloffset=1]
